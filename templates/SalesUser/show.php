    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 info">
                <div class="list-group">
                    ...
                    <button type="button" class="list-group-item list-group-item-action"><a
                            ...
                            иностранным валютам (Нацбанк РБ) </a></button>
                    <button type="button" class="list-group-item list-group-item-action"><a
                                href="http://dataportal.belstat.gov.by/AggregatedDb">Статистика внешней торговли
                            Республики Беларусь (belstat) </a></button>
                    <button type="button" class="list-group-item list-group-item-action"><a
                                href="https://www.butb.by/shedule/">Белорусская универсальная товарная биржа (БУТБ) </a>
                    </button>
                    <button type="button" class="list-group-item list-group-item-action"><a
                                href="https://www.trademap.org">Статистика мировой торговли (TRADE MAP) </a></button>
                    <button type="button" class="list-group-item list-group-item-action"><a
                                href="https://www.clal.it/index.php">Анализ молочного рынка и мировые тенденции
                            (clal.it) </a></button>
                    <button type="button" class="list-group-item list-group-item-action"><a
                                href="https://globaldairytrade.info/">Мировой аукцион молочного рынка (GTD) </a>
                    </button>
                    <button type="button" class="list-group-item list-group-item-action"><a
            ...
            <div class="col-12 col-sm-12 col-md-4 col-lg-9 col-xl-9 report">
                ...
                <a class="btn btn-success"  href="?type=salesuser&action=export" target="_blank">Export to Excel</a>
<br><br>
                <?php
